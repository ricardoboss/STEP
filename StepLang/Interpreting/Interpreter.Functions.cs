...
public partial class Interpreter
{
    public void Visit(CallStatementNode statementNode)
    {
        ...
        if (variable.Value is not FunctionResult function)
            throw new InvalidResultTypeException(statementNode.CallExpression.Location, variable.Value, ResultType.Function);
    ...
    {
        var definition = new UserDefinedFunctionDefinition(expressionNode.Location, expressionNode.Parameters, expressionNode.Body.Statements);
