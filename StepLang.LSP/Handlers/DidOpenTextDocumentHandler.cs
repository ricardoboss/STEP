...
public class DidOpenTextDocumentHandler(ILogger<DidOpenTextDocumentHandler> logger, ILanguageServerFacade server) : DidOpenTextDocumentHandlerBase
{
    ...
    {
        Task.Run(() => RunDiagnostics(request.TextDocument));
